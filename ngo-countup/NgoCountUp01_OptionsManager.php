...
class NgoCountUp01_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'ngo-countup'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'ngo-countup'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'ngo-countup'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'ngo-countup'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'ngo-countup');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'ngo-countup'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'ngo-countup');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'ngo-countup'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'ngo-countup') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'ngo-countup');
            case 'false':
                return __('false', 'ngo-countup');

            case 'Administrator':
                return __('Administrator', 'ngo-countup');
            case 'Editor':
                return __('Editor', 'ngo-countup');
            case 'Author':
                return __('Author', 'ngo-countup');
            case 'Contributor':
                return __('Contributor', 'ngo-countup');
            case 'Subscriber':
                return __('Subscriber', 'ngo-countup');
            case 'Anyone':
                return __('Anyone', 'ngo-countup');
        }
        return $optionValue;
    }
